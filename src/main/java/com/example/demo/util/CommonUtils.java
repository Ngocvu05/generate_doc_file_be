...
public class CommonUtils {
    ...
    public static void replacePlaceholderTables(Map<String, String> data, List<XWPFTable> tables) {
        fillDataToWordFileTables(tables, data);
    }
    ...
    public static void replacePlaceholder(PdfData data, List<XWPFParagraph> paragraphs) {
        ...
        placeholderMap.put("no_month", data.getNo_month());
    ...
    public  static Map<String, String> createRecordFromPdfData(PdfData data) {
        ...
        record.put("no_month", data.getNo_month());
        return record;
    }
    ...
    private static void fillDataToWordFileTables(List<XWPFTable> tables, Map<String, String> placeholderMap) {
